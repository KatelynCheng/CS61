...
; exercise 4: Now take all the stored values in your array (2^0 all the way to 2^9)
; and print their binary in form 0000 0000 0000 0001 (this is 2^0 for example)
.orig x3000
